...
with open(r'C:\Users\Admin\Excel_R\Linkedin_Project\location_Model.pkl','rb') as file:
    tfidf = pickle.load(file)

DATA = pd.read_csv(r'C:\Users\Admin\Excel_R\Linkedin_Project\Clean_data.csv')
